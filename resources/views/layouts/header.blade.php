...
<header class="bg-dark py-3" style="background-color: #000000;">
    <!-- Bootstrap CSS -->
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('learnMore') }}">About Us</a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="col-auto">
                @if (Auth::check())
                    <div class="text-light mt-2">
                        <a href="{{ route('user.index') }}" style="color: white"><i class="fas fa-user-circle mr-1"></i>{{ Auth::user()->name }}</a> |
